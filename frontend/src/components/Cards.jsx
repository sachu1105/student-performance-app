...
const Cards = ({ student, onClick }) => {
  return (
    <div
      className="max-w-sm rounded-lg overflow-hidden cursor-pointer border 	 shadow-lg bg-white p-6 hover:shadow-xl transition-shadow duration-300"
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <p className="text-gray-600">Place: {student.place}</p>
      </div>
    </div>
  );
};
